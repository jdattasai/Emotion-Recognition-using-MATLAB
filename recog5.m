function classes = recog5(img)
disp('training SVM classifier5 with T5 vector features.........');
C = csvread('T5.csv');%textscan(fid,'%f%f%f%f%f%f%f%f%f%f%f%f%f%f','delimiter',',');  % Import data
