function classes = recog4(img)
disp('training SVM classifier4 with T4 vector features.........');
C = csvread('T4.csv');%textscan(fid,'%f%f%f%f%f%f%f%f%f%f%f%f%f%f','delimiter',',');  % Import data
